<div class="fixed top-0 z-50">
    ...
    <div class=" relative w-auto bg-white bg-opacity-70 flex items-center ">
        ...
        <img src="{{ asset('src/images/heliosLogo.png') }}" alt=" logo helios" class="h-10 w-auto sm:h-auto">
        </div>
        <div class="inset-0 bg-gradient-to-b from-white to-transparent absolute z-0"></div>
